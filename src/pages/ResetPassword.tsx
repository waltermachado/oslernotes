...
export default function ResetPassword() {
  ...
  if (!ready && !tokenError) {
    return (
      <div className="min-h-screen bg-canvas flex flex-col items-center justify-center p-4">
        <div className="w-full max-w-md bg-surface rounded-2xl shadow-xl border border-cream-300/50 p-8">
          <div className="text-ink-700 font-medium">Validando link…</div>
      ...
      <div className="min-h-screen bg-canvas flex flex-col items-center justify-center p-4">
        <div className="w-full max-w-md">
          ...
          <div className="bg-surface rounded-2xl shadow-xl border border-cream-300/50 p-8">
            <h1 className="text-2xl font-bold text-ink-900 mb-2">Redefinir senha</h1>
            <div className="bg-rose-50 border border-rose-100 text-rose-400 text-sm p-3 rounded-lg mb-5">
              {tokenError}
            </div>
            <Link
              to="/forgot-password"
  ...
  if (success) {
    return (
      <div className="min-h-screen bg-canvas flex flex-col items-center justify-center p-4">
        <div className="w-full max-w-md bg-surface rounded-2xl shadow-xl border border-cream-300/50 p-8">
          <h1 className="text-2xl font-bold text-ink-900 mb-2">Senha atualizada</h1>
          <p className="text-ink-500 text-sm mb-6">Sua senha foi redefinida com sucesso.</p>
          <button
            type="button"
  ...
  return (
    <div className="min-h-screen bg-canvas flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-surface rounded-2xl shadow-xl border border-cream-300/50 p-8">
          <h1 className="text-2xl font-bold text-ink-900 mb-1">Redefinir senha</h1>
          <p className="text-ink-500 text-sm mb-6">Defina uma nova senha para sua conta.</p>
          ...
          <form onSubmit={onSubmit} className="space-y-4">
            ...
            <div className="text-xs text-ink-500">Mínimo 10 caracteres.</div>
